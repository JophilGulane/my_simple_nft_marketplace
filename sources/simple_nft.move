...
module nft::sui_nft_marketplace {
    ...
    public struct JaysChainNFT has key, store {
        id: UID,
        /// Name for the token
        name: string::String,
    ...
    entry fun burn_nft(nft: JaysChainNFT) {
        let JaysChainNFT { id, name: _, description: _, url: _ } = nft;
        object::delete(id)
    }
    ...
    public fun burn(nft: JaysChainNFT) {
        let JaysChainNFT { id, name: _, description: _, url: _ } = nft;
        object::delete(id)
    }
    ...
    /// Get the NFT's name
    public fun name(nft: &JaysChainNFT): &string::String {
        &nft.name
    }

    /// Get the NFT's description
    public fun description(nft: &JaysChainNFT): &string::String {
        &nft.description
    }

    /// Get the NFT's URL
    public fun url(nft: &JaysChainNFT): &Url {
        &nft.url
    }

    /// Get the NFT's ID
    public fun nft_id(nft: &JaysChainNFT): ID {
        object::id(nft)
    }
